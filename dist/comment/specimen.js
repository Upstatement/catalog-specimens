...
var Comment = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Comment, [{
    ...
    value: function render() {
      ...
      }, (0, _dayjs["default"])(date).format('DD MMM YYYY')))), _react["default"].createElement("div", {
        className: "catalog-comment--text"
      }, (0, _reactHtmlParser["default"])(converter.makeHtml(children))));
    }
  }]);

  return Comment;
}(_react["default"].Component); // Comment.propTypes = {
...
var _default = (0, _catalog.Specimen)(undefined, undefined, {
  withChildren: true
})(Comment);
